# Generated by Django 2.0.7 on 2018-08-02 17:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(limit_choices_to={'image_type': 'door'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='room_door_image_path', to='escapegame.Image'),
        ),
        migrations.AddField(
            model_name='escapegameroom',
            name='escape_game',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(limit_choices_to={'image_type': 'room'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='room_image_path', to='escapegame.Image'),
        ),
        migrations.AddField(
            model_name='escapegamechallenge',
            name='challenge_image_path',
            field=models.ForeignKey(limit_choices_to={'image_type': 'challenge'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chall_map_image_path', to='escapegame.Image'),
        ),
        migrations.AddField(
            model_name='escapegamechallenge',
            name='room',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(limit_choices_to={'image_type': 'door'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='corridor_door_image_path', to='escapegame.Image'),
        ),
        migrations.AddField(
            model_name='escapegame',
            name='map_image_path',
            field=models.ForeignKey(limit_choices_to={'image_type': 'map'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='game_map_image_path', to='escapegame.Image'),
        ),
        migrations.AddField(
            model_name='escapegame',
            name='sas_door_image_path',
            field=models.ForeignKey(limit_choices_to={'image_type': 'door'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sas_door_image_path', to='escapegame.Image'),
        ),
        migrations.AddField(
            model_name='escapegame',
            name='video_brief',
